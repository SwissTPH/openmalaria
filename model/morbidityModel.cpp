...
double MorbidityModel::_riskFromMaternalInfection;
std::vector<double> MorbidityModel::_prevalenceByGestationalAge;


void MorbidityModel::init() {
...
bool MorbidityModel::eventNeonatalMortality() {
  return W_UNIFORM() <= _riskFromMaternalInfection;
}

void MorbidityModel::setRiskFromMaternalInfection(int nCounter, int pCounter){
