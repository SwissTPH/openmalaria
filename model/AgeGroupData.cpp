...
const double AgeGroupData::agemin[nages] = { 0, 0.99, 1.99, 2.99, 3.99, 4.99, 5.99, 6.99, 7.99, 8.99, 9.99, 10.99, 11.99, 12.99, 13.99, 14.99, 19.99, 24.99, 29.99, 39.99, 49.99, 59.99};
...
double AgeGroupData::ageToWeight (double ageYears) {
	...
	double diff_wtprop = wtprop[age_group]-wtpropmin[age_group];
