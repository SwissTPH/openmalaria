...
void MolineauxInfection::init( const Parameters& parameters ){
    ...
    if( !pairwise_P_star_sample ){
        mean_shape_first_local_max = parameters[ParameterName::MEAN_LOCAL_MAX_DENSITY];
        sd_scale_first_local_max = parameters[ParameterName::SD_LOCAL_MAX_DENSITY];
        
        mean_shape_diff_pos_days = parameters[ParameterName::MEAN_DIFF_POS_DAYS];
        sd_scale_diff_pos_days = parameters[ParameterName::SD_DIFF_POS_DAYS];
