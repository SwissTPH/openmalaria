...
void Global::setModelVersion () {
  ...
  const int INCOMPATIBLITITIES[NUM_VERSIONS] = {
    ...
    LOGNORMAL_MASS_ACTION | LOGNORMAL_MASS_ACTION_PLUS_PRE_IMM | TRANS_HET | COMORB_TRANS_HET | TRANS_TREAT_HET | TRIPLE_HET,	// 2
    DUMMY_WITHIN_HOST_MODEL | INCLUDES_PK_PD | TRANS_HET | COMORB_TRANS_HET | TRANS_TREAT_HET | TRIPLE_HET,	// 3
    LOGNORMAL_MASS_ACTION_PLUS_PRE_IMM | TRANS_HET | COMORB_TRANS_HET | TRANS_TREAT_HET | TRIPLE_HET,	// 4
