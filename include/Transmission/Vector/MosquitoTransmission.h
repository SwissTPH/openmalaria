...
#ifndef Hmod_OM_Transmission_Vector_MosquitoTransmission
#define Hmod_OM_Transmission_Vector_MosquitoTransmission
 ...
 * vector transmission of malaria. The parts associated with mosquito
 * life-cycle are encapsulated in lifeCycle (MosquitoLifeCycle class).
 * 
 * This is only part of the model; the VectorModel class is largely just a
 * wrapper to support multiple mosquito species, and the Vector::SpeciesModel
