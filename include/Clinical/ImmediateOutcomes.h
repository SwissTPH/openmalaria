...
protected:
    virtual void doClinicalUpdate (WithinHost::WithinHostModel& withinHostModel, PerHostTransmission& hostTransmission, double ageYears, const AgeGroupData, Monitoring::AgeGroup ageGroup);
